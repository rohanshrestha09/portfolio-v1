...
const Contact = () => {
  ...
  return (
    <div
      className="w-full min-h-screen md:h-screen py-6 flex flex-col justify-evenly items-center sm:gap-12 gap-6"
      id="contact"
    >
      ...
      <div className="flex flex-col lg:flex-row sm:gap-12 gap-6 justify-between w-full">
        ...
        <form
          className="flex flex-col w-full lg:w-[47%] sm:gap-8 gap-6"
          onSubmit={(e) => {
